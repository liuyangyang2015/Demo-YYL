...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements mypackage.HelloWorldService {
    ...
    public mypackage.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.HelloWorldSoapBindingStub _stub = new mypackage.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.HelloWorldSoapBindingStub _stub = new mypackage.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
