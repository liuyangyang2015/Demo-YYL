package com.panda.demo.jmsdemo.producer;
 ...
 * 编程方式均一致，Java 中不需要管细节，至于究竟是队列还是主题，那是服务器的事， 因为我们客户端只根据 JNDI 名称编码，不对消息的处理方式负责。
 * 一般步骤： 1. 获得一个 JBoss 上下文引用 2. 创建连接工厂 3. 使用连接工厂创建连接 4. 使用连接创建会话 5. 通过 JNDI 查找
 * Queue 或 Topic 作为目的地 6. 使用会话和目的地创建消息生产者 7. 使用会话创建消息 8. 发送消息
 */
